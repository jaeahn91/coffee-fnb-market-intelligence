...
METRICS = {
    ...
    # v1 (2026-06호) 트리거 판정: A-1 ET 프리미엄이 2026-05에도 임계선 +$0.8 위 유지(+$1.03).
    # raw 기반이라 processed 재생성 불필요. 판정한 숫자를 재현 가드에 고정한다.
    "et_premium_2026_05": (lambda: _et_premium("2026-05"),
                           "2026-05", 0.02, "에티오피아 단가 프리미엄 $/kg @2026-05 (v1 트리거 판정)"),
}
